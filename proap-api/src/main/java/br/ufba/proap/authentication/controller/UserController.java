...
public class UserController {
    ...
    @PatchMapping("/review-user-role")
    public ResponseEntity<Void> reviewUserRole(@RequestBody @Valid ReviewUserRole dto) {
        this.service.reviewUserRole(dto.userId(), dto.status());
